...
$row = $stmt->fetch(PDO::FETCH_ASSOC);	
			...
			if($_POST['newfunc']!="" && $_POST['functional_area']=="Others"){
                ...
                $spl_instrtns = htmlspecialchars($_POST['spl_instrtns'], ENT_QUOTES);
	...
	else
	{
		 ...
		 else if(empty($PMinE))
		{
         ...
         {
             $msgg[]="Please give Special Instructions";
         }
		/* else if(empty($PEduc))
			  {
 ...
 echo "Field ".htmlspecialchars($key)." is ".htmlspecialchars($value)."<br>";	*/
			...
			{				
				...
				if ($con->query($create_job) === TRUE) {
					echo "New Job Posted successfully";
				} else {
					echo "Error: " . $create_job . "<br>" . $con->error;
				}
  ...
  "INSERT INTO tbl_cand_skills (Csk_User_Id,Csk_Job_Id,Csk_Skill_Id) VALUES ('".$_SESSION['empPhase2']."','".$job_id_phase2['Job_Id']."',$skill);";					
    ...
    <tr>
            <td colspan='2' style='background:#0274bb;' align='center'>
				...
				// $admin_email1="admin@needyin.com";
