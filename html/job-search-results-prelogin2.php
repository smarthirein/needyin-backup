...
$row = $stmt->fetch(PDO::FETCH_ASSOC);
			...
			$cj2="select * from tbl_jobposted where FIND_IN_SET('".$result_cj1['skill_Id']."', Job_Skill) and Job_Status='1'"; 			  
        ...
        if(isset($_POST['loc'])){
			...
			$sql1= "SELECT J.*,qo.Qual_Name,Ed.contact_name,L.Loc_Name
			  ...
			  $sql1= "SELECT J.*,qo.Qual_Name,Ed.contact_name,L.Loc_Name
									...
									LEFT JOIN tbll_emplyer Ed on J.emp_id= Ed.emp_id 
									LEFT JOIN tbl_qualification qo on J.PEduc_Id=qo.Qual_Id
									where  created >='".$day30."' GROUP BY J.emp_id";					
									$resultcj2 = mysqli_query($con,$sql1);  
		  } 
			else if(isset($_POST['day7'])){
			 echo $day7=date('Y-m-d', strtotime("-7 days"));
			  //echo "no jobs";
			 echo $sql1= "SELECT J.*,qo.Qual_Name,Ed.contact_name,L.Loc_Name
									FROM tbl_jobposted J		
									JOIN tbl_location L on J.Loc_Id=L.Loc_Id
									LEFT JOIN tbll_emplyer Ed on J.emp_id= Ed.emp_id 
									LEFT JOIN tbl_qualification qo on J.PEduc_Id=qo.Qual_Id
									where  created >='".$day7."' GROUP BY J.emp_id";	exit;				
									$resultcj2 = mysqli_query($con,$sql1);  
		  } 
		  else if(isset($_POST['day90'])){
			  ...
			  $sql1= "SELECT J.*,qo.Qual_Name,Ed.contact_name,L.Loc_Name
									...
									LEFT JOIN tbll_emplyer Ed on J.emp_id= Ed.emp_id 
									LEFT JOIN tbl_qualification qo on J.PEduc_Id=qo.Qual_Id
									where  created >='".$day90."' GROUP BY J.emp_id";					
									$resultcj2 = mysqli_query($con,$sql1);  
		  } 
		  else{
                        ...
                        <div class="col-md-3">
                            <div class="search-filter" >
                                ...
                                <div class="search-section">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="job-search-results-prelogin1.php?day7=true">                                              
                                                <label for="ltest3">Active Last 7 days</label>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="job-search-results-prelogin1.php?day30=true">											
                                                <label for="ltest4">Active last 30 days</label>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="job-search-results-prelogin1.php.php?90day=true">                                               
