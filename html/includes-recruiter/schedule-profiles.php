											...
											<table width="100%" cellpadding="0" cellspacing="0">
												...
												<tr width="50%">
													<th class="text-center" width="25%">Job Name </th> 
													 <th class="text-center" width="25%">Scheduled Date</th>
												</tr>
											</table>	
									    </th>   											
                                     
										<!--<th class="text-center rem-filter" width="120px">Action</th>-->
                                    </tr>
                                </thead>
								  <tbody><?php $i=1;?>
									<?php if($count !=0)  {   while ($row2 = mysqli_fetch_array($resultv1)) {?>
										...
										<td><?php echo $i;?></td>
											...
											<table width="100%" cellpadding="0" cellspacing="0" class="sche">
												<?php 
												$sql4 = "SELECT * FROM interviewscheduled WHERE emp_id='".$row2['emp_id']."' and juser_id='".$row2['JUser_Id']."'"; 
