            ...
            <section class="jobseekar-profile">              
                ...
                <div class="container">
                    <ul class="bcrumb-listjobs">
                        ...
                        <li> <a href="jobseeker-profile.php"><?php echo $rows['companyname'] ?></a> </li>
                        ...
                        <div class="container">
                            ...
                            <div class="notifications-block">
                                <div class="title-block-tab">
                                    <h4 class="flight">Notifications <span class="fbold"></span></h4> </div>
                                        ...
                                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            while($nt_data=mysqli_fetch_array($noti_res))
                                                 {  
                                                  ...
                                                  ?>
                                                <tr>
                                                   <td> <a href="jobseeker-detail-recruiter.php?uid=<?php echo $nt_data['profile_id'] ?>&noti_id=<?php echo $nt_data['id']?>"><?php echo ucfirst($data['JFullName']);?></td>
                                                    <td><?php echo $nt_data['description'];?></td>
                                                    <td>
