<?php 
$uname=base64_decode($_GET['name']);
$cname=base64_decode($_GET['company']);
...
<table width='750' border='0' cellspacing='0' cellpadding='0' style='font-family:arial; margin:0 auto;'>
        					 ...
        					 <tr>
								            <td  width='750'colspan='2' style='background:url(https://www.needyin.com/img/thankyou_img.png) no-repeat center 0; background-size: 750px 402px; height:375px;' >
								              ...
								              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "$cname" ?> viewed or expressed interest in your Needyin profile.<br>You can now login to your account using your email-id and password to view the recruiter details.
								              </div>
					        ...
					        <tr>
					            <td colspan='2' style='background:#90bd14;  height: 115px;' align='center'>
					                ...
					                <p style='font-size:20px; font-weight:bold; color:#fff; margin:0; padding-bottom:15px;  margin:0;'>Click here : <a href=".$siteurl.">NeedyIn </a></p>
					            </td>
					        </tr>
					        <tr>
