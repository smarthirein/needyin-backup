...
LEFT JOIN tbl_jobposted jp ON sJ.emp_id = jp.emp_id
...
WHERE sJ.emp_id='".$row['emp_id']."' AND sJ.JobId='".$_GET['jobId']."' Group by J.JUser_Id"; 																		
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <article class="dbpage-title">
                                <h4 class="txt-blue h4 pull-left"> <i class="fa fa-thumbs-o-up" aria-hidden="true"></i> Shorlisted (<?php echo $count; ?>)</h4> <span class="pull-right"><a href="rec-jobs.php"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> Back to Posted Jobs list</a></span></article>
                        </div>
                    </div>
