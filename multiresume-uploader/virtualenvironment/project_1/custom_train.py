...
TRAIN_DATA = trim_entity_spans(convert_dataturks_to_spacy("Merge-Valid.json"))
...
def main(model=None,new_model_name="training",
    output_dir='/home/smarthirein/Documents/Resume_rework_Project-/demo_resume_parsing',n_iter=150):
    ...
    for _, annotations in TRAIN_DATA:
        for ent in annotations.get("entities"):#changes single string to multistrin
            ner.add_label(ent[2])
