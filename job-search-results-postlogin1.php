...
$row = $stmt->fetch(PDO::FETCH_ASSOC);
        ...
        {
			$languages=$_POST['skill_name'];
	 $cj1="select skill_Id from tbl_masterskills where skill_Name='".$languages."'";
			
			$resultcj1 = mysqli_query($con,$cj1);
            $result_cj1=mysqli_fetch_array($resultcj1);
			 $result_cj1['skill_Id'];
			 
			$cj2="select * from tbl_jobposted where FIND_IN_SET('".$result_cj1['skill_Id']."', Job_Skill) "; 			  
        ...
        if(isset($_POST['search']))
        {
          ...
          //   print_r($lang_ids); exit;
			...
			$sql1= "SELECT J.*,qo.Qual_Name,Ed.contact_name,L.Loc_Name
									...
									LEFT JOIN tbll_emplyer Ed on J.emp_id= Ed.emp_id 
									LEFT JOIN tbl_qualification qo on J.PEduc_Id=qo.Qual_Id
									where  J.Sal_Range >='".$str1[0]."' and J.Sal_Range <='".$str1[1]."'GROUP BY J.emp_id";					
									$resultcj2 = mysqli_query($con,$sql1);  
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
						 <div class="job-list">
                                ...
                                if($counts!="") { ?>
                                    <p><span class="fbold txt-blue"><?php echo $counts ?></span> Jobs found in Software Development</p>
                                    <?php } else { ?>
                                    <p><span class="fbold txt-blue"></span> No Jobs found in Software Development</p>
                                    <?php } ?>
                                </div>
                                <!-- job list block -->
								<?php  if($cc!='0')
                                ...
                                <!--/ job list block -->
								<?php } } //else { echo "no jobs"; } ?> 
                            </div>
                            <!-- middle list jobs -->
                            <div class="job-list">
                                <div class="noofjobs brdbg-white">
                                    <p><span class="fbold txt-blue"><?php echo $cc;?></span> Jobs found in Software Development</p>
                                </div>
                                <!-- job list block -->
								<?php  
                                if($cc!='0')
                                ...
                                <div class="brdbg-white list-block">
                                    <div class="row job-title-list">
                                        <div class="col-md-8"> <a class="txt-blue" href="job-detail-postlogin.php?uid=<?php echo $j_data['emp_id'];?>&jid=<?php echo $j_data['Job_Id'];?>"><?php echo $row2['Desig_Name'];?> </a> <span><?php echo $j_data['Comp_Name'];?></span> </div>
                                        <div class="col-md-4 text-right">
                                            <figure>
                                                <a href="javascript:void(0)"><img src="<?php echo $j_data['eLogo'];?>"></a>
                                            </figure>
                                        </div>
                                    </div>
                                    <div class="usermain-features">
                                        <ul>
                                         ...
                                         <?php    $loc_query="select * from tbl_location where Loc_Id=".$j_data['Loc_Id'];  
                                          ...
                                          $loc_data=mysqli_fetch_array($loc_res); ?>
                                            <li><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $loc_data['Loc_Name'];?></li>
                                            <li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $j_data['created'];?></li>
                                        </ul>
                                    </div>
                                    <div class=" list-emp-keyskills">
                                        <h6 class="h6">Key Skills</h6>
                                    ...
                                    <?php    $emp_query="select * from tbll_emplyer where emp_id=".$j_data['emp_id'];  
                                        ...
                                        <p>Salary: <?php echo $j_data['Sal_Range'];?>,00,000 Lakhs PA <span class="pull-right">Posted by <?php echo $emp_data['contact_name'];?> </span></p>
                                    </div>
                                </div>
                                <!--/ job list block -->
							<?php } 
                            ...
                            <div class="right-block-list" id="right-list">
                                ...
                                <div class="email-news brdbg-white">
                                    ...
                                    <div class="mail-input brdbg-white">
                                        ...
                                        </div> <input type="submit" name="Subs" class="waves-effect waves-light btn btn-blue-sm btn-block" value="Subscribe"> </div>
                                </form>
								</div>
                                <!--/ email letter-->
                               ...
                               <div class="email-news brdbg-white">
                                    ...
                                    <ul class="similar-links-list">
                                      ...
                                      foreach ($skill_ids as $skill_id) {
                                                     ...
                                                     ?><li>
													 <form method="post">
													 <input type="checkbox" id="test<?php echo $skill_name['skill_Name']; ?>" name="skill_name" value="<?php echo $skill_name['skill_Name']; ?>" onclick="this.form.submit();"/>
													 <label for="test<?php echo $skill_name['skill_Name']; ?>"><?php echo $skill_name['skill_Name']; ?> </label>
													 </form>
													 <!--<a href="job-search-results-prelogin1.php?skill_name=<?php //echo $skill_name['skill_Name']; ?>"> <?php //echo $skill_name['skill_Name']; ?> </a>-->
													 </li><?php
                        ...
                        <div class="search-section">
                            ...
                            <ul>
                                 <form  method="post" >
									  ...
									  <?php 											
										$sql2 = "SELECT Loc_Id,Loc_Name FROM tbl_location";
										$query2 = mysqli_query($con, $sql2);
										if(!$query2)
										echo mysqli_error($con);
										?>
