...
if(!empty($_FILES['file'])){
	...
	function parseData($input)
	{
		...
		$res = shell_exec("python3 /var/www/dev.needyin.com/html/multiresume-uploader/virtualenvironment/project_1/custom_t.py 2>&1"); //2>&1 @comments.KEK
		if(isset($res))
		{  
