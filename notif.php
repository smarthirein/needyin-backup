        ...
        <tr height='43px'>
         ...
         <tr>
               <td colspan='2' style='background:#90bd14;' align='center'>
                    <p style='font-size:15px; line-height:20px; color:#fff; padding:5px ; text-align: justify;'>Dear <?php echo $emp_name?>,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A new profile is identified matching with your job details which are close to your skills,location and / or other criteria. </p>
                </td>
        </tr>
        <tr>
        ...
        <tr height='370'>
                ...
                <table style='margin-bottom: 185px; width: 400px; margin-left: 60px;'>
                        <tr >
                            ...
                            <td   align='center' ><p style='font-size:14px; color:white; width:120px; text-decoration:none;margin-left: 50px;'>I joined this portal recently. To get my details please click on the link below<br><br><a href='<?php echo $siteurl;?>'>NeedyIn </a></p>
	                      </td>
