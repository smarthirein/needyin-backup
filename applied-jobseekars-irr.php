...
LEFT JOIN tbl_qualification qo on Ed.Qual_Id=qo.Qual_Id  
 ...
 WHERE ap.emp_id ='".$row['emp_id']."' and jp.Job_Id='".$_GET['jobId']."' and ap.relavent='no' and ap.user_status='A'";	
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php $sql3 = "SELECT Count(*) as ID FROM tbl_applied WHERE emp_id='".$row['emp_id']."' and JobId='".$_GET['jobId']."' and relavent='no' and user_status='A'";
